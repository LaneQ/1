...
<table width="780" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td width="561" align="left" valign="top">      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td align="left" valign="top"><br>            <img src="images/xssj.gif" width="221" height="28"></td>
        </tr>
        <tr>
...
rs.open "select top 100 pagenum,name,discount,score,mark,vipprice,id,author,productdate,price2,price1,discount,pic from product order by adddate desc",conn,1,1
              ...
              <tr align="center">
                <td colspan="2"><br>
                  <form name="form1" method="post" action="">
                    <%
showpage totalput,MaxPerPage,"new.asp"
%>
                  </form> </td>
              </tr>
          </table></td>
