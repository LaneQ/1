...
<table width="780" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <td width="561" align="left" valign="top">      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td align="left" valign="top"><br>            <img src="images/tzts.gif" width="221" height="27"></td>
        </tr>
        <tr>
...
rs.open "select pagenum,discount,score,name,mark,vipprice,id,author,productdate,price2,price1,discount,pic from product where recommend=1 order by adddate desc",conn,1,1
